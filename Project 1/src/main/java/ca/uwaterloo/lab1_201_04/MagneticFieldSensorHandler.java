...
/**
 * Receives and manages magnetic field sensor data readings.
 */
class MagneticFieldSensorHandler implements SensorEventListener {
     ...
     *
     * @param eventInfo array with magnetic field information, x-coordinate is index 0, y-coordinate is index 1, and
